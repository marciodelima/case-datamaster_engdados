...
def test_analyze_news_success():
    ...
    mock_response.choices = [MagicMock(message=MagicMock(content='{"acoes": ["PETR4"], "sentimento": "positivo", "resumo": "Alta do petróleo"}'))]
    mock_client.chat.completions.create.return_value = mock_response

    result = analyze_news("Petrobras sobe", "Alta no preço do petróleo", mock_client)
...
@patch("app.azure_functions.news_sentiment_analyzer.function_app.get_openai_client")
@patch("app.azure_functions.news_sentiment_analyzer.function_app.BlobServiceClient")
@patch("app.azure_functions.news_sentiment_analyzer.function_app.DefaultAzureCredential")
